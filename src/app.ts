...
const mongodbUri = 'mongodb://admin:Ph6!58QD5#@ds119406.mlab.com:19406/luxerdb';
const options = {
    keepAlive: true,
...
app.post('/api/create-package', apiController.createPackage);
app.get('/api/retrieve-package/:id', apiController.getPackage);
app.get('/api/retrieve-packages/:email', apiController.getPackages);
app.delete('/api/delete-package/', apiController.deletePackage);
